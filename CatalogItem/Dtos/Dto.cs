...
{
    public record LaptopDto(Guid Id, string StoreID, string Classify, string Name, string Description, decimal Price, int Quantity, Boolean isAvailable, List<string> Image);
