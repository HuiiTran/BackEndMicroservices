...
{
    public record StaffDto(Guid Id, string UserName, string PassWord, string Email, string Address, string Name, string PhoneNumber, string Image, decimal Salary, string Role);
